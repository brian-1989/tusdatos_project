...
class Process(db.Model):
    ...
    process_number = Column("process_number", String, nullable=False, unique=True)
...
class Details(db.Model):
    ...
    incident_number = Column("incident_number", String, primary_key=True, nullable=False)
    ...
    process_number = Column(
        "process_number", String, ForeignKey("public.process.process_number"), nullable=False)
